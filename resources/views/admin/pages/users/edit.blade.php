                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Email Address" required=""
                                    name="general[email]" value="{{ $user->email }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="select2 form-control" name="general[role_id]">
                                    ...
                                    @foreach ($roles as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($user->hasRole($item->id)) selected @endif>{{ ucfirst($item->name) }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="select2 form-control" name="general[blood_group]">
                                    ...
                                    <option @if ($user->blood_group == 'A-') selected @endif value="B-">B-</option>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="select2 form-control" name="general[religion]">
                                    <option @if ($user->religion == 'islam') selected @endif value="islam">Islam
                                    </option>
                                    <option @if ($user->religion == 'hinduism') selected @endif value="hinduism">Hinduism
                                    </option>
                                    <option @if ($user->religion == 'christianity') selected @endif value="christianity">
                                        Christianity</option>
                                    <option @if ($user->religion == 'buddhism') selected @endif value="buddhism">Buddhism
                                    </option>
                                    <option @if ($user->religion == 'others') selected @endif value="others">Others
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Present Address" required=""
                                    name="general[address]" value="{{ old('general.address', $user->address) }}">
                            </div>
                        </div>
                        ...
                        <div class="row" id="player-info"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="select2 form-control" name="player[player_type]">
                                    <option @if ($user->player->player_type == '') selected @endif value="">Choose
                                    </option>
                                    <option @if ($user->player->player_type == 'registered') selected @endif value="registered">
                                        Registered</option>
                                    <option @if ($user->player->player_type == 'guest') selected @endif value="guest">Guest
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="select2 form-control" name="player[player_role]">
                                    ...
                                    <option @if ($user->player->player_role == 'batsman') selected @endif value="batsman">Batsman
                                    </option>
                                    <option @if ($user->player->player_role == 'bowler') selected @endif value="bowler">Bowler
                                    </option>
                                    <option @if ($user->player->player_role == 'all-rounder') selected @endif value="all-rounder">All
                                        Rounder</option>
                                    <option @if ($user->player->player_role == 'wicketkeeper') selected @endif value="wicketkeeper">Wicket
                                        Keeper</option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="select2 form-control" name="player[batting_style]">
                                    <option value="">Choose</option>
                                    <option @if ($user->player->batting_style == 'right-handed') selected @endif value="right-handed">Right
                                        Handed</option>
                                    <option @if ($user->player->batting_style == 'left-handed') selected @endif value="left-handed">Left
                                        Handed</option>
                                    <option @if ($user->player->batting_style == 'switch hitter') selected @endif value="switch hitter">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="select2 form-control" name="player[bowling_style]">
                                    ...
                                    <option @if ($user->player->bowling_style == 'medium') selected @endif value="medium">Meidum
                                    </option>
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Jursey Number</small><span
                                        class="required-mark">*</span></label>
                                <input type="text" class="form-control" placeholder="Jursey Number" required=""
                                    name="player[jursey_number]" value="{{ $user->player->jursey_number }}">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="form-label">Jursey Name</small><span class="required-mark">*</span></label>
                                <input type="text" class="form-control" placeholder="Jursey Name" required=""
                                    name="player[jursey_name]" value="{{ $user->player->jursey_name }}">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="block font-medium form-label">Jersey Size</label>
                            ...
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Chest Measurement</small><span class="required-mark">*</span></label>
                                <input type="text" class="form-control" placeholder="Chest Measurement" required=""
                                    name="player[chest_measurement]" value="{{ $user->player->chest_measurement }}">
                            </div>
                        </div>
