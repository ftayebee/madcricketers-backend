            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-md-10">
                            <h4 class="fw-bold mb-2">{{ $match->teamA->name }} <span class="text-muted">vs</span>
                                {{ $match->teamB->name }}</h4>
                            <p class="mb-1"><strong>Tournament:</strong> {{ $match->tournament->name ?? 'N/A' }}</p>
                            <p class="mb-1"><strong>Match Status:</strong>
                            ...
                            <div class="mt-3 row">
                                <div class="col-md-3">
                                    <strong>Overs:</strong> <span id="live_overs">0.0</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Runs:</strong> <span id="live_runs">0</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Wickets:</strong> <span id="live_wickets">0</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Current Batsmen:</strong>
                                    <span id="live_batsman1">-</span> &amp; <span id="live_batsman2">-</span>
                                </div>
                            </div>
                            <div class="mt-2 row">
                                <div class="col-md-4">
                                    <strong>Bowler:</strong> <span id="live_bowler">-</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Strike:</strong> <span id="live_strike">-</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Extras:</strong> <span id="live_extras">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
