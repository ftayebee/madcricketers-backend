            ...
            <form action="{{ route('admin.teams.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="background: #daf0ff;">
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            <div class="form-group">
                                <label for="captain_selector2">Captain</label>
                                <select class="form-control" id="captain_selector2" name="captain_id" style="width: 100%;">
                                    <option value="">No captain selected</option>
                                </select>
                                <small class="text-muted">Captain options are limited to the selected team players.</small>
                            </div>
                        </div>
                    </div>
                </div>
