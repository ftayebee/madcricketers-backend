...
<head>
    ...
    <meta name="description"
        content="MadCricketers – A live cricket score and financial data management tool, fully built with Laravel by AlgoHive IT." />
                        ...
                        <div class="card-body px-3 py-5">
                            <div class="mx-auto mb-4 text-center auth-logo">
                                <a href="https://madcricketers.com" class="logo-dark">
                                    <img src="{{ asset('storage/assets/images/main-logo-dark.png') }}" height="62"
                                        alt="logo dark">
                                </a>

                                <a href="index.html" class="logo-light">
                                    <img src="{{ asset('storage/assets/images/main-logo-light.png') }}" height="28"
                                        alt="logo light">
                                </a>
                            </div>
                            @yield('content')
